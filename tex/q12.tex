...
\begin{document}
  ...
  \section{Induced coupling and the divergence structure}
    ...
    \subsection{On the gauge--gravity hierarchy}
      ...
      The robust, scheme-independent statement is weaker but exact: the
  ...
  \section{Conclusion}
    ...
    \end{align*}
    What is therefore structural, and scheme-independent, is the
    \emph{difference in divergence degree} between the two sectors.
    ...
    The earlier reading of the hierarchy as a tuning-free prediction
    is withdrawn, in line with the matching-data status of the
    Einstein sector in Gravity~3.3~\cite{Beau2026h}.
    ...
    The complete synthesis --- joint equations of motion, the
    gauge--gravity back-reaction $T^{\mathrm{YM}}_{\mu\nu}$, the
    Born--Infeld gauge--gravity completion, and any quantitative
    hierarchy ratio --- is addressed in Q13.
