...
\begin{document}
  ...
  \begin{abstract}
    ...
    the SU(3) sector inherits the conditional
    status~[H-color] of~\cite{Beau2026a35,Beau2026a36}.
  ...
  \section{Introduction}
    ...
    \subsection{Organisation}
      ...
      result and the inherited conditionality on [H-color].
  ...
  \section{Epistemic status, conditionalities, and relation to the
  Standard Model gauge group}
    ...
    \subsection{Inherited conditionality on [H-color]}
      ...
      in~\cite{Beau2026a35}, and conditionally on
      ...
      compact gauge group $G_\Pi$; it does not depend on [H-color]
      itself.
      The [H-color] conditionality applies only to the identification
      $G_\Pi = \mathrm{SU}(3) \times \mathrm{SU}(2) \times \mathrm{U}(1)$,
      which is an input, not a derived result.
      ...
      \begin{itemize}
        ...
        colour-adapted graph, conditional on [H-color] for the
        standard graph~\cite{Beau2026a35};
        \item [H-color] is numerically confirmed for
        $q \in \{151, 211\}$ in~\cite{Beau2026a36};
  ...
  \section{Conclusion}
    ...
    the SU(3) sector is conditional on [H-color].
