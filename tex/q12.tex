...
\begin{document}
  ...
  \begin{abstract}
    ...
    the SU(3) sector is unconditional at the effective level:
    $[H\text{-color}]_{\mathrm{eff}}$ (equality of capacity exponents
    $\delta_c = \delta_{\omega c} = \delta_{\omega^2c}$) is established
  ...
  \section{Epistemic status and relation to the Standard Model gauge group}
    ...
    \subsection{Epistemic status of each result}
      ...
      \begin{table}[h]
        ...
        \begin{tabular}{lll}
          ...
          & Proved; $[H\text{-color}]_{\mathrm{eff}}$
    ...
    \subsection{Analytical status of [H-color]}
      ...
      in~\cite{Beau2026a35}.
      For the standard Cayley graph, the effective co-admissibility
      $[H\text{-color}]_{\mathrm{eff}}$ --- equality of the capacity
      exponents $\delta_c = \delta_{\omega c} = \delta_{\omega^2 c}$ in
      the large-$q$ limit --- is now established analytically
      in~\cite{Beau2026a35,Beau2026a36} via two complementary mechanisms:
      the intra-coset Vandermonde symmetry (Schur's lemma for the
      Heisenberg centre, O31) and the modulation-frequency argument for
      the O12 block-averaged fingerprint observable (O32).
      ...
      \begin{itemize}
        ...
        colour-adapted graph; unconditional at the effective level
        ($[H\text{-color}]_{\mathrm{eff}}$ proved) for the standard
  ...
  \section{Conclusion}
    ...
    the SU(3) sector is unconditional at the effective level,
    with $[H\text{-color}]_{\mathrm{eff}}$ established
    in~\cite{Beau2026a35,Beau2026a36}.
